...
**Deelnemer Naam:** `Jonas Cruz Martinez`  
**Workshop Datum:** `27-11-2025`  
**Doel:** `Mijn eerste CI/CD pipeline bouwen`  
**GitHub Gebruikersnaam:** `JonasCruzMartinez`  
**Verwachte Site URL:** `https://JonasCruzMartinez.github.io/devops-workshop-vitepress/`
